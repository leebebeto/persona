...
class Index extends React.Component {
  constructor(props) {
        super(props);
        this.temp = document.getElementsByTagName('script')[4];
        this.testVariable = {value: "this is a test"};
        this.data = {    
        name: 'John Smith',
        imgURL: 'http://lorempixel.com/100/100/',
        hobbyList: ['coding', 'writing', 'skiing']
    }
        console.log(this.testVariable.value);
